...
function init(){
  var uuid = "26be53efebae4f019fc87cc1320cef47";
  var used_url = 'https://www.fintechersapi.com/bank/huanan/digitalfin/customers?uuid=' + uuid + '&api_key=870b2dee-163a-4767-a13a-6c4ff1adc648';
  $.ajax({
      url: used_url,                        // url位置
      type: 'get',                   // post/get
      ...
      success: function (response) { 
        ...
        document.getElementById('birth').innerHTML = response.birthday;
        document.getElementById('create_date').innerHTML = response.create_date;
        document.getElementById('career').innerHTML =  response.career;
        document.getElementById('income').innerHTML =  response.income;
        document.getElementById('education').innerHTML =  response.education;
        document.getElementById('gender').innerHTML =  response.gender;
        document.getElementById('ID').innerHTML =  response.identity_id;
        document.getElementById('marriage').innerHTML =  response.marital;
        document.getElementById('residence').innerHTML =  response.residence;
        document.getElementById('service').innerHTML =  response.service_units;
      },
